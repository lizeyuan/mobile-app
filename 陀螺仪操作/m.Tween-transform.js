...
function css(element, attr , val){
    if(attr == 'scale' || attr == 'scaleX' || attr == 'scaleY'
        || attr == 'scaleX' || attr == 'scaleY' || attr == 'rotate'
        || attr == 'rotateX'|| attr == 'rotateY' || attr == 'skew'
        || attr == 'skewX' || attr == 'skewY' || attr == 'translate'
    ...
    init.el.timer = setInterval(
        function(){
            ...
            if(t>d){
                ...
                for(var s in b){
                    var val = Number(Number(Tween[init.type](t,b[s],c[s],d)).toFixed(2));
                    css(init.el, s, val);
                }
            }
        },
